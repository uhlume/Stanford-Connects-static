...
/* $TARGET_EMAIL = array(EMAIL_NAME."@stanford\.edu$",EMAIL_NAME."@alumni\.stanford\.edu$",EMAIL_NAME."@stanfordalumni\.org$"); */

$TARGET_EMAIL = array(EMAIL_NAME."@alumni\.stanford\.edu$",
                      EMAIL_NAME."@stanford\.edu$",
                      EMAIL_NAME."@stanfordalumni\.org$");

            /* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","jgingold@stanford.edu");

            /* Help: http://www.tectite.com/fmdoc/site_domain.php */
$SITE_DOMAIN = "stanfordconnects.stanford.edu";           // your website domain name
...
$LOGDIR = "/Library/WebServer/etc/connects/submissions";                           // directory for log files; empty string to
                                        // disallow log files
...
$CSVDIR = "/Library/WebServer/etc/connects/submissions";                       // directory for csv files; empty string to
                                    // disallow csv files
...
$TEMPLATEDIR = "/Library/WebServer/etc/connects/formmail_templates";                  // directory for template files; empty string
...
$FORM_INI_FILE = "/Library/WebServer/etc/connects/formmail.ini";
